...
class InceptionNeXtBlock_9(nn.Module):
    def __init__(self, dim, kernel_size=7, exp_rate=4, drop_path=0.):
        ...
        self.dwconv_h = nn.Conv3d(gc, gc, kernel_size=(9, 9, 1), padding=(4, 4, 0), groups=gc)
        self.dwconv_w = nn.Conv3d(gc, gc, kernel_size=(1, 9, 9), padding=(0, 4, 4), groups=gc)
        self.dwconv_d = nn.Conv3d(gc, gc, kernel_size=(9, 1, 9), padding=(4, 0, 4), groups=gc)
