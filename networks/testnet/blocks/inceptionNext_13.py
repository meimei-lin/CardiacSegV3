...
class InceptionNeXtBlock_13(nn.Module):
    def __init__(self, dim, kernel_size=7, exp_rate=4, drop_path=0.):
        ...
        self.dwconv_h = nn.Conv3d(gc, gc, kernel_size=(13, 13, 1), padding=(6, 6, 0), groups=gc)
        self.dwconv_w = nn.Conv3d(gc, gc, kernel_size=(1, 13, 13), padding=(0, 6, 6), groups=gc)
        self.dwconv_d = nn.Conv3d(gc, gc, kernel_size=(13, 1, 13), padding=(6, 0, 6), groups=gc)
